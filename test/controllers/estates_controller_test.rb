...
class EstatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estate" do
    assert_difference('Estate.count') do
      post estates_url, params: { estate: { age: @estate.age, name: @estate.name, other: @estate.other, place: @estate.place, rent: @estate.rent } }
    end
  ...
  test "should update estate" do
    patch estate_url(@estate), params: { estate: { age: @estate.age, name: @estate.name, other: @estate.other, place: @estate.place, rent: @estate.rent } }
